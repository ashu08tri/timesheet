...
export function TimesheetEditor({ weekStart, projects }: TimesheetEditorProps) {
  ...
  const readOnly = timesheet ? !['DRAFT', 'REVERTED'].includes(timesheet.status) : false
      ...
      <div className="card overflow-hidden">
        ...
        {timesheet?.status === 'REVERTED' && (
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-red-700 dark:text-red-300">Timesheet reverted</p>
