...
export function EntryRow({ entry, projects, dayLabel, isWeekend, readOnly, onUpdate, onDelete }: EntryRowProps) {
  ...
  // System-generated overtime entries (see the auto-split rule) aren't directly
  // editable — they're recalculated whenever the underlying Standard hours change.
  const locked = readOnly || entry.isAutoGenerated
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          {entry.isAutoGenerated && (
            <span className="text-[9px] font-bold uppercase tracking-wide text-amber-600 dark:text-amber-400">Auto · Overtime</span>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          type="button"
          onClick={() => !locked && onUpdate('isBillable', !entry.isBillable)}
