...
import { Clock, Mail, Lock, ArrowRight, AlertCircle, Eye, EyeOff, Building2 } from 'lucide-react'
import toast from 'react-hot-toast'

const DEMO_COMPANY = 'timepro-demo'
const DEMO_ACCOUNTS = [
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    setError('')
    const res = await signIn('credentials', { company, email, password, redirect: false })
    setLoading(false)
    if (res?.error) {
      setError('Invalid company, email, or password. Try the demo accounts below.')
    } else {
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  value={company}
                  onChange={e => setCompany(e.target.value.trim().toLowerCase())}
              ...
              <p className="text-gray-600 text-xs mt-1.5">The company ID from your invite or sign-up (e.g. timepro-demo).</p>
            </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-center text-gray-600 text-xs mt-3">
              Company <code className="text-gray-500">{DEMO_COMPANY}</code>, password: <code className="text-gray-500">password123</code>
            </p>
          </div>
